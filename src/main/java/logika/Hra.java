...
import Observers.EndObserver;
import Observers.ItemObserver;
...
public class Hra implements IHra {
     ...
     */
    public Hra(ItemObserver exitObserver, MapObserver mapObserver, ItemObserver itemObserver, ItemObserver batohObserver) {
        herniPlan = new HerniPlan(exitObserver, mapObserver, itemObserver);
        if (exitObserver != null) {
            exitObserver.update(herniPlan.getAktualniProstor().getSeznamVychodu());
        }
        herniPlan.notifyItemsObserver();
        batoh = new Batoh(batohObserver);
    ...
    public String zpracujPrikaz(String radek) {
        ...
        if (platnePrikazy.jePlatnyPrikaz(slovoPrikazu)) {
            ...
            if (herniPlan.getAktualniProstor() == herniPlan.getViteznyProstor()) {
                ...
                if (endObserver != null) {
                    endObserver.gameEndedByVictory();
                }
            }
        } else {
    ...
    void setKonecHry(boolean konecHry) {
        ...
        if (endObserver != null) {
            endObserver.gameEndedByCommand();
        }
    }
    ...
    public List<String> getPrikazy() {
        String nazvyPrikazu = platnePrikazy.vratNazvyPrikazu();
        return Arrays.asList(nazvyPrikazu.split(" "));
    }
