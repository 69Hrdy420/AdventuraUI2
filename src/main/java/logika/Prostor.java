...
public class Prostor {
    ...
    private final Map<String, Vec> seznamVeci;   // seznam věcí v prostoru
    ...
    public List<String> getSeznamVychodu() {
        Collection<Prostor> vychody = getVychody();
        List<String> vychodyString = new ArrayList<>();
        for (Prostor p : vychody) {
            vychodyString.add(p.getNazev());
        }
        return vychodyString;
    }
